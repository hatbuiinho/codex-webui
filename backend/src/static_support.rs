...
fn static_asset_response(asset: CachedStaticAsset) -> Response {
    ...
    if asset.content_type.starts_with("text/html") {
        ...
        csp.push_str(" https://hcaptcha.com https://*.hcaptcha.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self' data:; connect-src 'self' https://hcaptcha.com https://*.hcaptcha.com; worker-src 'self' blob:; frame-src 'self' https://hcaptcha.com https://*.hcaptcha.com; object-src 'none'; base-uri 'none'; frame-ancestors 'none'");
